        ...
        <div className="row h-100">
          ...
          >
            ...
            <li className="mt-auto">
              ...
              >
                <i className="fas fa-arrow-alt-circle-left text-white"></i> Back
                to Homepage
              </a>
            </li>
            <li className="mt-3">
          ...
          <div className="col-lg-10 col-md-9 col-sm-8 p-4 h-100 overflow-auto">
            {this.state.showComponent === "posts" &&
            this.state.isSigned === "OK" ? (
              <Posts />
            ) : null}
            {this.state.showComponent === "pages" &&
            this.state.isSigned === "OK" ? (
              <Pages />
            ) : null}
            {this.state.showComponent === "categories" &&
            this.state.isSigned === "OK" ? (
              <Categories />
            ) : null}
            ...
            {this.state.showComponent === "comments" &&
            this.state.isSigned === "OK" ? (
              <Comments />
            ) : null}
            {this.state.showComponent === "menu" &&
            this.state.isSigned === "OK" ? (
              <Menu />
            ) : null}
            {this.state.showComponent === "subscribers" &&
            this.state.isSigned === "OK" ? (
              <Subscribers />
            ) : null}
          </div>
