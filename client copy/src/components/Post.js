...
class Post extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        `https://www.instagram.com/graphql/query/?query_id=17888483320059182&variables=%7B%22id%22:%2232976122967%22,%22first%22:4,%22after%22:null%7D`
      )
      .then((res) => {
      ...
      <div className="CONTENT">
        ...
        <div className="POST__center">
          ...
          <p className="POST__date">
            {new Date(this.state.post.createdAt).toLocaleString("en-gb", {
              month: "short",
              day: "numeric",
            })}
          </p>
          ...
          <a
            ...
            href={"/categories/" + this.state.category.title}
          >
          ...
          <div className="POST">
            ...
            <div className="POST__sidebar">
              <div className="POST__sidebar-user">
                ...
                {this.state.menu.map((menus) => (
                  <div className="POST__sidebar-about" key={menus._id}>
                    {menus.sidebar}
                  </div>
                ))}
              </div>
              ...
              <a
                ...
                href={"/post/" + this.state.posts[0].title}
              >
                <img
                  className="POST__sidebar-recent-image"
                  src={this.state.posts[0].image}
                  alt=""
                />
        ...
        <div className="RELATED">
          ...
          <ul className="RELATED__posts">
            {this.state.posts
              .filter(
                (recent) =>
                  recent.category === this.state.post.category &&
                  recent._id !== this.state.post._id
              )
              .slice(0, 3)
              .map((recent) => (
                <li className="CONTENT__blog-post" key={recent._id}>
                  <a
                    ...
                    href={`/post/${recent.title}`}
                    style={{ backgroundImage: "url(" + recent.image + ")" }}
                  >
                    {""}
                  </a>
                  <a
                  ...
                  >
                    <p className="CONTENT__blog-post-date">
                      {new Date(recent.createdAt).toLocaleString("en-gb", {
                        month: "short",
                        day: "numeric",
                      })}
                    </p>
